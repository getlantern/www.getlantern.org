...
angular.module('GetLanternSiteApp')
  .factory('constants', function () {
    ...
    //INSTALLER_DATA_URL: 'https://s3.amazonaws.com/lantern-installers/latest.json'
      INSTALLER_DATA_URL: 'https://s3.amazonaws.com/lantern-installers/dummy-latest.json'
    };
  });
